...
import com.simplemobiletools.studentcalendarpaid.helpers.CalDAVHandler
...
class SelectCalendarsDialog(val activity: com.simplemobiletools.studentcalendarpaid.activities.SimpleActivity, val callback: () -> Unit) {
    var prevAccount = ""
    var dialog: AlertDialog
    var view = (activity.layoutInflater.inflate(com.simplemobiletools.studentcalendarpaid.R.layout.dialog_select_calendars, null) as ViewGroup)
    ...
    init {
        ...
        dialog = AlertDialog.Builder(activity)
                .setPositiveButton(com.simplemobiletools.studentcalendarpaid.R.string.ok) { dialogInterface, i -> confirmSelection() }
                .setNegativeButton(com.simplemobiletools.studentcalendarpaid.R.string.cancel, null)
                .create().apply {
                    activity.setupDialogStuff(view, this, com.simplemobiletools.studentcalendarpaid.R.string.select_caldav_calendars)
                }
    }

    private fun addCalendarItem(isEvent: Boolean, text: String, tag: Int = 0, shouldCheck: Boolean = false) {
        val calendarItem = activity.layoutInflater.inflate(if (isEvent) com.simplemobiletools.studentcalendarpaid.R.layout.calendar_item_calendar else com.simplemobiletools.studentcalendarpaid.R.layout.calendar_item_account,
