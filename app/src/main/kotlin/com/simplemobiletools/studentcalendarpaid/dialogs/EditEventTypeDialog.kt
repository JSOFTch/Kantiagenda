...
class EditEventTypeDialog(val activity: Activity, var eventType: EventType? = null, val callback: (eventType: EventType) -> Unit) {
    ...
    init {
        if (eventType == null)
            eventType = EventType(0, "", bgColor)

        val view = activity.layoutInflater.inflate(com.simplemobiletools.studentcalendarpaid.R.layout.dialog_event_type, null).apply {
        ...
        AlertDialog.Builder(activity)
                ...
                .create().apply {
                    activity.setupDialogStuff(view, this, if (isNewEvent) com.simplemobiletools.studentcalendarpaid.R.string.add_new_type else com.simplemobiletools.studentcalendarpaid.R.string.edit_type) {
                        ...
                        getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener {
                            ...
                            if (title.isEmpty()) {
                                activity.toast(com.simplemobiletools.studentcalendarpaid.R.string.title_empty)
                                return@setOnClickListener
                            } else if (isEventTypeTitleTaken) {
                                activity.toast(com.simplemobiletools.studentcalendarpaid.R.string.type_already_exists)
                                return@setOnClickListener
                            }
                            ...
                            if (eventType!!.id != -1) {
                                ...
                                activity.toast(com.simplemobiletools.studentcalendarpaid.R.string.editing_calendar_failed)
                            }
                        }
                    }
                }
