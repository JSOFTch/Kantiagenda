...
class ManageEventTypesAdapter(activity: com.simplemobiletools.studentcalendarpaid.activities.SimpleActivity, val eventTypes: ArrayList<EventType>, val listener: DeleteEventTypesListener?, recyclerView: MyRecyclerView,
    ...
    override fun getActionMenuId() = com.simplemobiletools.studentcalendarpaid.R.menu.cab_event_type
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = createViewHolder(com.simplemobiletools.studentcalendarpaid.R.layout.item_event_type, parent)
    ...
    private fun askConfirmDelete() {
        ...
        if (activity.dbHelper.doEventTypesContainEvent(eventTypes)) {
            ...
            val items = ArrayList<RadioItem>().apply {
                add(RadioItem(MOVE_EVENTS, res.getString(com.simplemobiletools.studentcalendarpaid.R.string.move_events_into_default)))
                add(RadioItem(DELETE_EVENTS, res.getString(com.simplemobiletools.studentcalendarpaid.R.string.remove_affected_events)))
            }
    ...
    private fun deleteEventTypes(deleteEvents: Boolean) {
        ...
        for (key in selectedKeys) {
            ...
            if (type.id == DBHelper.REGULAR_EVENT_TYPE_ID) {
                activity.toast(com.simplemobiletools.studentcalendarpaid.R.string.cannot_delete_default_type)
