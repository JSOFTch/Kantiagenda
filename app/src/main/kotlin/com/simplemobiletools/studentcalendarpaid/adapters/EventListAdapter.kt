...
class EventListAdapter(activity: com.simplemobiletools.studentcalendarpaid.activities.SimpleActivity, var listItems: ArrayList<ListItem>, val allowLongClick: Boolean, val listener: RefreshRecyclerViewListener?,
                       recyclerView: MyRecyclerView, itemClick: (Any) -> Unit) : MyRecyclerViewAdapter(activity, recyclerView, null, itemClick) {

    private val topDivider = resources.getDrawable(com.simplemobiletools.studentcalendarpaid.R.drawable.divider_width)
    ...
    override fun getActionMenuId() = com.simplemobiletools.studentcalendarpaid.R.menu.cab_event_list
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyRecyclerViewAdapter.ViewHolder {
        val layoutId = when (viewType) {
            ITEM_EVENT -> com.simplemobiletools.studentcalendarpaid.R.layout.event_list_item
            ITEM_EVENT_SIMPLE -> com.simplemobiletools.studentcalendarpaid.R.layout.event_list_item_simple
            else -> com.simplemobiletools.studentcalendarpaid.R.layout.event_list_section
        }
    ...
    private fun setupListEvent(view: View, listEvent: ListEvent) {
        view.apply {
            ...
            var bgColor = Color.parseColor("#311b92")
