...
import com.simplemobiletools.studentcalendarpaid.models.MonthViewEvent
...
class MonthView(context: Context, attrs: AttributeSet, defStyle: Int) : View(context, attrs, defStyle) {
    ...
    private var redColorValue = Color.BLUE
    ...
    init {
        ...
        val normalTextSize = resources.getDimensionPixelSize(com.simplemobiletools.studentcalendarpaid.R.dimen.normal_text_size)
        ...
        val smallerTextSize = resources.getDimensionPixelSize(com.simplemobiletools.studentcalendarpaid.R.dimen.smaller_text_size)
    ...
    private fun initWeekDayLetters() {
        dayLetters = context.resources.getStringArray(com.simplemobiletools.studentcalendarpaid.R.array.week_day_letters).toMutableList() as ArrayList<String>
