...
class DBHelper private constructor(val context: Context) : SQLiteOpenHelper(context, DB_NAME, null, DB_VERSION) {
    ...
    private fun addRegularEventType(db: SQLiteDatabase) {
        val regularEvent = context.resources.getString(com.simplemobiletools.studentcalendarpaid.R.string.regular_event)
        val eventType = EventType(REGULAR_EVENT_TYPE_ID, regularEvent, bgColor)
        addEventType(eventType, db)
    }

    fun insert(event: Event, addToCalDAV: Boolean, activity: com.simplemobiletools.studentcalendarpaid.activities.SimpleActivity? = null, callback: (id: Int) -> Unit) {
    ...
    fun update(event: Event, updateAtCalDAV: Boolean, activity: com.simplemobiletools.studentcalendarpaid.activities.SimpleActivity? = null, callback: (() -> Unit)? = null) {
