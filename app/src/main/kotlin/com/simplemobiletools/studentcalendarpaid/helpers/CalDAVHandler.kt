...
import com.simplemobiletools.studentcalendarpaid.extensions.refreshCalDAVCalendars
import com.simplemobiletools.studentcalendarpaid.extensions.scheduleCalDAVSync
...
class CalDAVHandler(val context: Context) {
    fun refreshCalendars(activity: com.simplemobiletools.studentcalendarpaid.activities.SimpleActivity? = null, callback: () -> Unit) {
    ...
    fun getCalDAVCalendars(activity: com.simplemobiletools.studentcalendarpaid.activities.SimpleActivity? = null, ids: String = ""): List<CalDAVCalendar> {
    ...
    private fun fetchCalDAVCalendarEvents(calendarId: Int, eventTypeId: Int, activity: com.simplemobiletools.studentcalendarpaid.activities.SimpleActivity?) {
