...
class Config(context: Context) : BaseConfig(context) {
    ...
    private fun getMediumFontSize() = context.resources.getDimension(com.simplemobiletools.studentcalendarpaid.R.dimen.day_text_size) / context.resources.displayMetrics.density
