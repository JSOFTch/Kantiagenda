...
class IcsImporter(val activity: com.simplemobiletools.studentcalendarpaid.activities.SimpleActivity) {
    ...
    private fun tryAddCategories(categories: String, context: Context) {
        ...
        curEventTypeId = if (eventId == -1) {
            val newTypeColor = if (curCategoryColor == -2) context.resources.getColor(com.simplemobiletools.studentcalendarpaid.R.color.color_primary) else curCategoryColor
