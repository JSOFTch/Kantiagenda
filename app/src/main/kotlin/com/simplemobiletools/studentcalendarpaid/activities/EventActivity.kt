...
import com.simplemobiletools.studentcalendarpaid.dialogs.*
...
import com.simplemobiletools.studentcalendarpaid.helpers.STORED_LOCALLY_ONLY
import com.simplemobiletools.studentcalendarpaid.models.CalDAVCalendar
...
class EventActivity : com.simplemobiletools.studentcalendarpaid.activities.SimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.simplemobiletools.studentcalendarpaid.R.layout.activity_event)

        supportActionBar?.setHomeAsUpIndicator(com.simplemobiletools.studentcalendarpaid.R.drawable.ic_cross)
        ...
        event_reminder_1.setOnClickListener {
            handleNotificationAvailability {
                if (config.wasAlarmWarningShown) {
                    ...
                    ConfirmationDialog(this, messageId = com.simplemobiletools.studentcalendarpaid.R.string.reminder_warning, positive = com.simplemobiletools.studentcalendarpaid.R.string.ok, negative = 0) {
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(com.simplemobiletools.studentcalendarpaid.R.menu.menu_event, menu)
        if (wasActivityInitialized) {
            menu.findItem(com.simplemobiletools.studentcalendarpaid.R.id.delete).isVisible = mEvent.id != 0
            menu.findItem(com.simplemobiletools.studentcalendarpaid.R.id.share).isVisible = mEvent.id != 0
            menu.findItem(com.simplemobiletools.studentcalendarpaid.R.id.duplicate).isVisible = mEvent.id != 0
        }
        return true
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            com.simplemobiletools.studentcalendarpaid.R.id.save -> saveEvent()
            com.simplemobiletools.studentcalendarpaid.R.id.delete -> deleteEvent()
            com.simplemobiletools.studentcalendarpaid.R.id.duplicate -> duplicateEvent()
            com.simplemobiletools.studentcalendarpaid.R.id.share -> shareEvent()
    ...
    private fun setupEditEvent() {
        ...
        updateActionBarTitle(getString(com.simplemobiletools.studentcalendarpaid.R.string.edit_event))
    ...
    private fun setupNewEvent() {
        ...
        updateActionBarTitle(getString(com.simplemobiletools.studentcalendarpaid.R.string.new_event))
    ...
    private fun handleNotificationAvailability(callback: () -> Unit) {
        if (NotificationManagerCompat.from(applicationContext).areNotificationsEnabled()) {
            ...
            ConfirmationDialog(this, messageId = com.simplemobiletools.studentcalendarpaid.R.string.notifications_disabled, positive = com.simplemobiletools.studentcalendarpaid.R.string.ok, negative = 0) {
                callback()
            }
        }
    }
    ...
    private fun checkRepetitionLimitText() {
        event_repetition_limit.text = when {
            mRepeatLimit == 0 -> {
                event_repetition_limit_label.text = getString(com.simplemobiletools.studentcalendarpaid.R.string.repeat)
                resources.getString(com.simplemobiletools.studentcalendarpaid.R.string.forever)
            }
            mRepeatLimit > 0 -> {
                event_repetition_limit_label.text = getString(com.simplemobiletools.studentcalendarpaid.R.string.repeat_till)
                ...
                event_repetition_limit_label.text = getString(com.simplemobiletools.studentcalendarpaid.R.string.repeat)
                "${-mRepeatLimit} ${getString(com.simplemobiletools.studentcalendarpaid.R.string.times)}"
            }
        }
    }
    ...
    private fun getAvailableMonthlyRepetitionRules(): ArrayList<RadioItem> {
        val items = arrayListOf(RadioItem(REPEAT_SAME_DAY, getString(com.simplemobiletools.studentcalendarpaid.R.string.repeat_on_the_same_day_monthly)))
        ...
        if (isLastDayOfTheMonth()) {
            items.add(RadioItem(REPEAT_LAST_DAY, getString(com.simplemobiletools.studentcalendarpaid.R.string.repeat_on_the_last_day_monthly)))
        }
        return items
    }

    private fun getAvailableYearlyRepetitionRules(): ArrayList<RadioItem> {
        val items = arrayListOf(RadioItem(REPEAT_SAME_DAY, getString(com.simplemobiletools.studentcalendarpaid.R.string.repeat_on_the_same_day_yearly)))
    ...
    private fun getRepeatXthDayString(includeBase: Boolean, repeatRule: Int): String {
        ...
        return if (includeBase) {
            ...
            val everyString = getString(if (isMaleGender(mEventStartDateTime.dayOfWeek)) com.simplemobiletools.studentcalendarpaid.R.string.every_m else com.simplemobiletools.studentcalendarpaid.R.string.every_f)
    ...
    private fun getBaseString(day: Int): String {
        return getString(if (isMaleGender(day)) {
            com.simplemobiletools.studentcalendarpaid.R.string.repeat_every_m
        } else {
            com.simplemobiletools.studentcalendarpaid.R.string.repeat_every_f
        })
    }
    ...
    private fun getOrderString(repeatRule: Int): String {
        ...
        return getString(when (order) {
            1 -> if (isMale) com.simplemobiletools.studentcalendarpaid.R.string.first_m else com.simplemobiletools.studentcalendarpaid.R.string.first_f
            2 -> if (isMale) com.simplemobiletools.studentcalendarpaid.R.string.second_m else com.simplemobiletools.studentcalendarpaid.R.string.second_f
            3 -> if (isMale) com.simplemobiletools.studentcalendarpaid.R.string.third_m else com.simplemobiletools.studentcalendarpaid.R.string.third_f
            4 -> if (isMale) com.simplemobiletools.studentcalendarpaid.R.string.fourth_m else com.simplemobiletools.studentcalendarpaid.R.string.fourth_f
            else -> if (isMale) com.simplemobiletools.studentcalendarpaid.R.string.last_m else com.simplemobiletools.studentcalendarpaid.R.string.last_f
        })
    }

    private fun getDayString(day: Int): String {
        return getString(when (day) {
            1 -> com.simplemobiletools.studentcalendarpaid.R.string.monday_alt
            2 -> com.simplemobiletools.studentcalendarpaid.R.string.tuesday_alt
            3 -> com.simplemobiletools.studentcalendarpaid.R.string.wednesday_alt
            4 -> com.simplemobiletools.studentcalendarpaid.R.string.thursday_alt
            5 -> com.simplemobiletools.studentcalendarpaid.R.string.friday_alt
            6 -> com.simplemobiletools.studentcalendarpaid.R.string.saturday_alt
            else -> com.simplemobiletools.studentcalendarpaid.R.string.sunday_alt
        })
    }
    ...
    private fun getRepeatXthDayInMonthString(includeBase: Boolean, repeatRule: Int): String {
        ...
        val monthString = resources.getStringArray(com.simplemobiletools.studentcalendarpaid.R.array.in_months)[mEventStartDateTime.monthOfYear - 1]
    ...
    private fun checkRepetitionRuleText() {
        when {
            mRepeatInterval.isXWeeklyRepetition() -> {
                event_repetition_rule.text = if (mRepeatRule == EVERY_DAY_BIT) getString(com.simplemobiletools.studentcalendarpaid.R.string.every_day) else getSelectedDaysString(mRepeatRule)
            }
            mRepeatInterval.isXMonthlyRepetition() -> {
                val repeatString = if (mRepeatRule == REPEAT_ORDER_WEEKDAY_USE_LAST || mRepeatRule == REPEAT_ORDER_WEEKDAY)
                    com.simplemobiletools.studentcalendarpaid.R.string.repeat else com.simplemobiletools.studentcalendarpaid.R.string.repeat_on
    ...
    private fun getMonthlyRepetitionRuleText() = when (mRepeatRule) {
        REPEAT_SAME_DAY -> getString(com.simplemobiletools.studentcalendarpaid.R.string.the_same_day)
        REPEAT_LAST_DAY -> getString(com.simplemobiletools.studentcalendarpaid.R.string.the_last_day)
    ...
    private fun updateReminder2Text() {
        event_reminder_2.apply {
            ...
            if (mReminder2Minutes == REMINDER_OFF) {
                text = resources.getString(com.simplemobiletools.studentcalendarpaid.R.string.add_another_reminder)
                alpha = 0.4f
                mReminder3Minutes = REMINDER_OFF
            } else {
    ...
    private fun updateCurrentCalendarInfo(currentCalendar: CalDAVCalendar?) {
        ...
        if (currentCalendar == null) {
            ...
            val mediumMargin = resources.getDimension(com.simplemobiletools.studentcalendarpaid.R.dimen.medium_margin).toInt()
            event_caldav_calendar_name.apply {
                text = getString(com.simplemobiletools.studentcalendarpaid.R.string.store_locally_only)
            ...
            event_caldav_calendar_name.apply {
                ...
                setPadding(paddingLeft, paddingTop, paddingRight, resources.getDimension(com.simplemobiletools.studentcalendarpaid.R.dimen.tiny_margin).toInt())
            }
    ...
    private fun saveEvent() {
        ...
        if (newTitle.isEmpty()) {
            toast(com.simplemobiletools.studentcalendarpaid.R.string.title_empty)
            event_title.requestFocus()
            return
        }
        ...
        if (newStartTS > newEndTS) {
            toast(com.simplemobiletools.studentcalendarpaid.R.string.end_before_start)
            return
        }
    ...
    private fun checkStartEndValidity() {
        val textColor = if (mEventStartDateTime.isAfter(mEventEndDateTime)) resources.getColor(com.simplemobiletools.studentcalendarpaid.R.color.red_text) else config.textColor
    ...
    private fun showOnMap() {
        if (event_location.value.isEmpty()) {
            toast(com.simplemobiletools.studentcalendarpaid.R.string.please_fill_location)
            return
        }
        ...
        if (intent.resolveActivity(packageManager) != null) {
            ...
            toast(com.simplemobiletools.studentcalendarpaid.R.string.no_app_found)
        }
    }
