...
class SettingsActivity : com.simplemobiletools.studentcalendarpaid.activities.SimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.simplemobiletools.studentcalendarpaid.R.layout.activity_settings)
        res = resources
        ...
        if (config.primaryColor == mStoredPrimaryColor) {
            dbHelper.getEventTypes {
                if (it.filter { it.caldavCalendarId == 0 }.size == 1) {
                    ...
                    eventType.color = mStoredPrimaryColor
    ...
    private fun setupSectionColors() {
        val adjustedPrimaryColor = mStoredPrimaryColor
...
*/
    ...
    private fun setupManageEventTypes() {
        settings_manage_event_types_holder.setOnClickListener {
            startActivity(Intent(this, com.simplemobiletools.studentcalendarpaid.activities.ManageEventTypesActivity::class.java))
        }
    }
    ...
    private fun showCalendarPicker() {
        ...
        SelectCalendarsDialog(this) {
            ...
            if (settings_caldav_sync.isChecked) {
                toast(com.simplemobiletools.studentcalendarpro.R.string.syncing)
            }
            ...
            Thread {
                ...
                if (settings_caldav_sync.isChecked) {
                    toast(com.simplemobiletools.studentcalendarpro.R.string.synchronization_completed)
                }
            }.start()
        }
    }
...
*/
    private fun setupDeleteAllEvents() {
        settings_delete_all_events_holder.setOnClickListener {
            ConfirmationDialog(this, messageId = com.simplemobiletools.studentcalendarpaid.R.string.delete_all_events_confirmation) {
                Thread {
...
/*
        ...
        settings_start_weekly_at_holder.setOnClickListener {
            ...
            RadioGroupDialog(this@SettingsActivity, items, config.startWeeklyAt) {
                if (it as Int >= config.endWeeklyAt) {
                    toast(com.simplemobiletools.studentcalendarpro.R.string.day_end_before_start)
                } else {
    ...
    */
    ...
    private fun setupReminderAudioStream() {
        ...
        settings_reminder_audio_stream_holder.setOnClickListener {
            val items = arrayListOf(
                    RadioItem(AudioManager.STREAM_ALARM, res.getString(com.simplemobiletools.studentcalendarpaid.R.string.alarm_stream)),
                    RadioItem(AudioManager.STREAM_SYSTEM, res.getString(com.simplemobiletools.studentcalendarpaid.R.string.system_stream)),
                    RadioItem(AudioManager.STREAM_NOTIFICATION, res.getString(com.simplemobiletools.studentcalendarpaid.R.string.notification_stream)),
                    RadioItem(AudioManager.STREAM_RING, res.getString(com.simplemobiletools.studentcalendarpaid.R.string.ring_stream)))
    ...
    private fun getAudioStreamText() = getString(when (config.reminderAudioStream) {
        AudioManager.STREAM_ALARM -> com.simplemobiletools.studentcalendarpaid.R.string.alarm_stream
        AudioManager.STREAM_SYSTEM -> com.simplemobiletools.studentcalendarpaid.R.string.system_stream
        AudioManager.STREAM_NOTIFICATION -> com.simplemobiletools.studentcalendarpaid.R.string.notification_stream
        else -> com.simplemobiletools.studentcalendarpaid.R.string.ring_stream
    })
...
/*
    ...
    private fun getDisplayPastEventsText(displayPastEvents: Int): String {
        return if (displayPastEvents == 0) {
            getString(com.simplemobiletools.studentcalendarpro.R.string.never)
        } else {
    ...
    private fun setupFontSize() {
        ...
        settings_font_size_holder.setOnClickListener {
            val items = arrayListOf(
                    RadioItem(FONT_SIZE_SMALL, res.getString(com.simplemobiletools.studentcalendarpro.R.string.small)),
                    RadioItem(FONT_SIZE_MEDIUM, res.getString(com.simplemobiletools.studentcalendarpro.R.string.medium)),
                    RadioItem(FONT_SIZE_LARGE, res.getString(com.simplemobiletools.studentcalendarpro.R.string.large)))
...
*/
    private fun getFontSizeText() = getString(when (config.fontSize) {
        FONT_SIZE_SMALL -> com.simplemobiletools.studentcalendarpaid.R.string.small
        FONT_SIZE_MEDIUM -> com.simplemobiletools.studentcalendarpaid.R.string.medium
        else -> com.simplemobiletools.studentcalendarpaid.R.string.large
    })
/*
    private fun setupCustomizeWidgetColors() {
        settings_customize_widget_colors_holder.setOnClickListener {
            Intent(this, com.simplemobiletools.studentcalendarpro.activities.WidgetListConfigureActivity::class.java).apply {
    ...
    private fun setupViewToOpenFromListWidget() {
        ...
        settings_list_widget_view_to_open_holder.setOnClickListener {
            val items = arrayListOf(
                    RadioItem(DAILY_VIEW, res.getString(com.simplemobiletools.studentcalendarpro.R.string.daily_view)),
                    RadioItem(WEEKLY_VIEW, res.getString(com.simplemobiletools.studentcalendarpro.R.string.weekly_view)),
                    RadioItem(MONTHLY_VIEW, res.getString(com.simplemobiletools.studentcalendarpro.R.string.monthly_view)),
                    RadioItem(YEARLY_VIEW, res.getString(com.simplemobiletools.studentcalendarpro.R.string.yearly_view)),
                    RadioItem(EVENTS_LIST_VIEW, res.getString(com.simplemobiletools.studentcalendarpro.R.string.simple_event_list)),
                    RadioItem(LAST_VIEW, res.getString(com.simplemobiletools.studentcalendarpro.R.string.last_view)))
...
*/
    private fun getDefaultViewText() = getString(when (config.listWidgetViewToOpen) {
        DAILY_VIEW -> com.simplemobiletools.studentcalendarpaid.R.string.daily_view
        WEEKLY_VIEW -> com.simplemobiletools.studentcalendarpaid.R.string.weekly_view
        MONTHLY_VIEW -> com.simplemobiletools.studentcalendarpaid.R.string.monthly_view
        YEARLY_VIEW -> com.simplemobiletools.studentcalendarpaid.R.string.yearly_view
        EVENTS_LIST_VIEW -> com.simplemobiletools.studentcalendarpaid.R.string.simple_event_list
        else -> com.simplemobiletools.studentcalendarpaid.R.string.last_view
    })
