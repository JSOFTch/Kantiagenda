...
import com.simplemobiletools.studentcalendarpaid.helpers.Config
...
import com.simplemobiletools.studentcalendarpaid.helpers.MonthlyCalendarImpl
...
class MonthFragment : Fragment(), MonthlyCalendar {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(com.simplemobiletools.studentcalendarpaid.R.layout.fragment_month, container, false)
        mRes = resources
    ...
    private fun showMonthDialog() {
        ...
        val view = layoutInflater.inflate(com.simplemobiletools.studentcalendarpaid.R.layout.date_picker, null)
        val datePicker = view.findViewById<DatePicker>(com.simplemobiletools.studentcalendarpaid.R.id.date_picker)
        ...
        AlertDialog.Builder(context!!)
                ...
                .setPositiveButton(com.simplemobiletools.studentcalendarpaid.R.string.ok) { dialog, which -> positivePressed(dateTime, datePicker) }
                .create().apply {
    ...
    private fun updateDays(days: ArrayList<DayMonthly>) {
        mHolder.month_view_wrapper.updateDays(days) {
            (activity as com.simplemobiletools.studentcalendarpaid.activities.MainActivity).openDayFromMonthly(Formatter.getDateTimeFromCode(it.code))
        }
    }
}
