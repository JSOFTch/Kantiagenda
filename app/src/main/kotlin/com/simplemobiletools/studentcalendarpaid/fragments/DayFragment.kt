...
import com.simplemobiletools.studentcalendarpaid.adapters.DayEventsAdapter
...
class DayFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(com.simplemobiletools.studentcalendarpaid.R.layout.fragment_day, container, false)
    ...
    private fun updateEvents(events: ArrayList<Event>) {
        ...
        DayEventsAdapter(activity as com.simplemobiletools.studentcalendarpaid.activities.SimpleActivity, events, mHolder.day_events) {
