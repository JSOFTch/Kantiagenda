...
import com.simplemobiletools.studentcalendarpaid.adapters.MyYearPagerAdapter
...
class YearFragmentsHolder : MyFragmentHolder() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater.inflate(com.simplemobiletools.studentcalendarpaid.R.layout.fragment_years_holder, container, false)
            ...
            addOnPageChangeListener(object : ViewPager.OnPageChangeListener {
                ...
                override fun onPageSelected(position: Int) {
                    ...
                    if (position < years.size) {
                        (activity as? com.simplemobiletools.studentcalendarpaid.activities.MainActivity)?.updateActionBarTitle("${getString(com.simplemobiletools.studentcalendarpaid.R.string.app_launcher_name)} - ${years[position]}")
                    }
                }
            })
    ...
    override fun updateActionBarTitle() {
        (activity as? com.simplemobiletools.studentcalendarpaid.activities.MainActivity)?.updateActionBarTitle("${getString(com.simplemobiletools.studentcalendarpaid.R.string.app_launcher_name)} - $currentYear")
    }
